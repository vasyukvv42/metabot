...
DESCRIPTION = 'FastAPI plugin for quickly developing MetaBot modules'
URL = 'https://github.com/vasyukvv42/metabot'
EMAIL = 'vasyukvv42@gmail.com'
...
setup(
    ...
    package_data={'fastapi_metabot': ['VERSION']},
